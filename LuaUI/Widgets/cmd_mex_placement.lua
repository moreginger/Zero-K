...
options = {
	drawicons = {
		i18nKey = i18nPrefix .. 'option_showincomeasicon',
		type = 'bool',
		value = true,
		noHotkey = true,
	...
	size = {
		i18nKey = i18nPrefix .. 'option_incomedisplaysize',
		type = "number",
		value = 40,
		min = 10,
		max = 150,
	...
	rounding = {
		i18nKey = i18nPrefix .. 'option_displaydecimaldigits',
		type = "number",
		value = 1,
		min = 1,
		max = 4,
	...
	catlabel = {
		i18nKey = i18nPrefix .. 'option_areamex',
		type = 'label',
		path = 'Settings/Interface/Building Placement',
	},
	area_point_command = {
		i18nKey = i18nPrefix .. 'option_pointclickqueuesmex',
		type = 'bool',
		value = true,
		path = 'Settings/Interface/Building Placement',
	},
	catlabel_terra = {
		i18nKey = i18nPrefix .. 'option_areaterramexaltwbydefault',
		type = 'label',
		path = 'Settings/Interface/Building Placement',
	},
	wall_low = {
		i18nKey = i18nPrefix .. 'option_lowwallheight',
		type = "number",
		value = 40,
		min = 2,
		max = 120,
	...
	wall_high = {
		i18nKey = i18nPrefix .. 'option_highwallheight',
		type = "number",
		value = 75,
		min = 2,
		max = 120,
	...
	burry_shallow = {
		i18nKey = i18nPrefix .. 'option_shallowburrydepth',
		type = "number",
		value = 55,
		min = 2,
		max = 120,
	...
	burry_deep = {
		i18nKey = i18nPrefix .. 'option_deepburrydepth',
		type = "number",
		value = 90,
		min = 2,
		max = 120,
