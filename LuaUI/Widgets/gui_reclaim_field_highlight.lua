...
options = {
	showhighlight = {
		i18nKey = i18nPrefix .. 'option_showfieldsummary',
		type = 'radioButton',
		value = 'constructors',
		items = {
	...
	flashStrength = {
		i18nKey = i18nPrefix .. 'option_fieldflashingstrength',
		type = 'number',
		value = flashStrength,
	...
	fontSizeMin = {
		i18nKey = i18nPrefix .. 'option_minimumfontsize',
		type = 'number',
		value = fontSizeMin,
	...
	fontSizeMax = {
		i18nKey = i18nPrefix .. 'option_maximumfontsize',
		type = 'number',
		value = fontSizeMax,
	...
	fontScaling = {
		i18nKey = i18nPrefix .. 'option_fontscalingfactor',
		type = 'number',
		value = fontScaling,
