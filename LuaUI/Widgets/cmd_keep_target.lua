...
options = {
	keepTarget = {
		i18nKey = i18nPrefix .. 'option_prioritiseoverriddenattacktarget',
		type = "bool",
		value = true,
		noHotkey = true,
	},
	keepTargetBombers = {
		i18nKey = i18nPrefix .. 'option_prioritiseoverriddenattackforbombers',
		type = "bool",
		value = false,
	...
	removeTarget = {
		i18nKey = i18nPrefix .. 'option_stopclearstarget',
		type = "bool",
		value = true,
		noHotkey = true,
	},
