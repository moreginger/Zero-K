...
options = {
	markingmenu = {
		i18nKey = i18nPrefix .. 'option_openmenusetahotkey',
		type = 'button',
		--OnChange defined later
	},

	iconDistance = {
		i18nKey = i18nPrefix .. 'option_icondistance20360',
		type = 'number',
		value = 50,
	...
	iconSize = {
		i18nKey = i18nPrefix .. 'option_iconsize10100',
		type = 'number',
		value = 20,
	...
	selectedIconSize = {
		i18nKey = i18nPrefix .. 'option_selectediconsize10100',
		type = 'number',
		value = 32,
		min=10,max=100,step=1,
		OnChange = OptionsChanged,
	...
	mouseMoveThreshold = {
		i18nKey = i18nPrefix .. 'option_mousemovethreshold102000',
		type = 'number',
		value = 900,
	...
	mouseIdleThreshold = {
		i18nKey = i18nPrefix .. 'option_mouseidlethreshold013s',
		type = 'number',
		value = 1,
	...
	keyboardOnly = {
		i18nKey = i18nPrefix .. 'option_keyboardonly',
		type = 'bool',
		value = false,
		OnChange = OptionsChanged,
	},
	...
	onlyOpenWithKeyboard = {
		i18nKey = i18nPrefix .. 'option_onlyopenwithkeyboard',
		type = 'bool',
		value = false,
		OnChange = OptionsChanged,
	},
	...
	qwertz = {
		i18nKey = i18nPrefix .. 'option_qwertzkeyboard',
		type = "bool",
		value = false,
		OnChange = OptionsChanged,
	},
	...
	alternateconfig = {
		i18nKey = i18nPrefix .. 'option_alternatekeyboardlayout',
		type = "bool",
		value = false,
		OnChange = OptionsChanged,
	},
	...
	allowMultiple = {
		i18nKey = i18nPrefix .. 'option_allowformultipleselectedunits',
		type = "bool",
		value = true,
		OnChange = OptionsChanged,
	},
