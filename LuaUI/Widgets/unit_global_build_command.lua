...
options = {
	updateRate = {
		i18nKey = i18nPrefix .. 'option_workerupdateratehighernumbersarefasterbutmorecpuintensive',
		type = 'number',
		min = 1, max = 4, step = 1,
		value = 1,
	},
	...
	separateConstructors = {
		i18nKey = i18nPrefix .. 'option_separateconstructors',
		type = 'bool',
		value = true,
	},
	
	splitArea = {
		i18nKey = i18nPrefix .. 'option_splitareacommands',
		type = 'bool',
		value = true,
	},
	
	autoConvertRes = {
		i18nKey = i18nPrefix .. 'option_convertresurrect',
		type = 'bool',
	...
	autoRepair = {
		i18nKey = i18nPrefix .. 'option_autorepair',
		type = 'bool',
		value = false,
	},
	
	cleanWrecks = {
		i18nKey = i18nPrefix .. 'option_autoreclaimresurrect',
		type = 'bool',
		value = false,
	},
	
	chicken = {
		i18nKey = i18nPrefix .. 'option_autochicken',
		type = 'bool',
	...
	intelliCost = {
		i18nKey = i18nPrefix .. 'option_intelligentcostmodel',
		type = 'bool',
		value = true,
	},
	
	alwaysShow = {
		i18nKey = i18nPrefix .. 'option_alwaysshow',
		type = 'bool',
		value = false,
	},
	
	drawIcons = {
		i18nKey = i18nPrefix .. 'option_drawstatusicons',
		type = 'bool',
		value = true,
	},

	isSelectionOverrideSetOption = {
		i18nKey = i18nPrefix .. 'option_globalbuildoverridesselectionrank',
		type = "bool",
		value = true,
		noHotkey = true,
	...
	selectionOverrideRankOption = {
		i18nKey = i18nPrefix .. 'option_globalbuildselectionoverride',
		type = 'number',
