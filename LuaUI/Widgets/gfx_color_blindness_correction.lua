...
options = {
	cbcType = {
		i18nKey = i18nPrefix .. 'option_colorblindnesstype',
		type = "radioButton",
		value = "none",
		items = {
			{key = "none", name = "None"},
	...
	cbcMethod = {
		i18nKey = i18nPrefix .. 'option_colorblindnesscorrectionmethod',
		type = "number",
		value = 2,
		min = 1, max = 2, step = 1,
		simpleMode = true,
	...
	cbcOnlySim = {
		i18nKey = i18nPrefix .. 'option_onlysimulatecolorblindness',
		type = 'bool',
		value = false,
		advanced = true,
	},
