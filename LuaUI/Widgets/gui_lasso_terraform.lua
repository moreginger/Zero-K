...
options = {
	catlabel = {
		i18nKey = i18nPrefix .. 'option_buildheight',
		type = 'label',
	},
	structure_holdMouse = {
		i18nKey = i18nPrefix .. 'option_terraformbyholdingmouseclick',
		type = "bool",
	...
	structure_altSelect = {
		i18nKey = i18nPrefix .. 'option_terraformbyselectingwithalt',
		type = "bool",
		value = false,
	},
	staticMouseTime = {
		i18nKey = i18nPrefix .. 'option_structureterraformpresstime',
		type = "number",
		value = 1, min = 0, max = 10, step = 0.05,
	},
	staticMouseThreshold = {
		i18nKey = i18nPrefix .. 'option_mousedragthreshold',
		type = "number",
		value = 20, min = 0, max = 400, step = 1,
	},
	label_preset = {
		type = 'label',
		i18nKey = i18nPrefix .. 'option_terraformpresethotkeys',
		path = HOTKEY_PATH
	},
	text_hotkey_level = {
		i18nKey = i18nPrefix .. 'option_levelpresets',
		type = 'text',
	...
	text_hotkey_raise = {
		i18nKey = i18nPrefix .. 'option_raisepresets',
		type = 'text',
