...
options = {
	updateNewDefaults = {
		i18nKey = i18nPrefix .. 'option_stayuptodate',
		type  = "bool",
		value = true,
		noHotkey = true,
	},
	setToDefault = {
		i18nKey = i18nPrefix .. 'option_settodefaultonce',
		type  = "bool",
		value = true,
		advanced = true,
		noHotkey = true,
	...
	maintainDefaultUI = {
		i18nKey = i18nPrefix .. 'option_resetonscreenresolutionchange',
		type  = "bool",
		value = true,
		noHotkey = true,
	},
	...
	interfacePreset = {
		i18nKey = i18nPrefix .. 'option_uipreset',
		type = 'radioButton',
		value = 'default',
		items = {
