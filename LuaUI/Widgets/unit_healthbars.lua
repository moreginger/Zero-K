...
options = {
	showhealthbars = {
		i18nKey = i18nPrefix .. 'option_showhealthbars',
		type = 'bool',
		value = true,
		--OnChange = function() Spring.SendCommands{'showhealthbars'} end,
	},
	drawFeatureHealth = {
		i18nKey = i18nPrefix .. 'option_drawhealthoffeaturescorpses',
		type = 'bool',
		value = false,
		noHotkey = true,
	...
	drawBarPercentages = {
		i18nKey = i18nPrefix .. 'option_drawpercentages',
		type = 'bool',
		value = true,
		noHotkey = true,
		OnChange = OptionsChanged,
	...
	flashJump = {
		i18nKey = i18nPrefix .. 'option_jumpreloadflash',
		type = 'bool',
		value = true,
		noHotkey = true,
	},
	barScale = {
		i18nKey = i18nPrefix .. 'option_barsizescale',
		type = 'number',
		value = 1,
		min = 0.5,
		max = 6,
	...
	minReloadTime = {
		i18nKey = i18nPrefix .. 'option_minreloadtime',
		type = 'number',
		value = 3,
		min = 1,
		max = 10,
	...
	debugMode = {
		i18nKey = i18nPrefix .. 'option_debugmode',
		type = 'bool',
		value = false,
		advanced = true,
		noHotkey = true,
	...
	unitMaxHeight = {
		i18nKey = i18nPrefix .. 'option_unitbarfadeheight',
		type = 'number',
	...
	unitPercentHeight = {
		i18nKey = i18nPrefix .. 'option_unitbarpercentageheight',
		type = 'number',
	...
	unitTitleHeight = {
		i18nKey = i18nPrefix .. 'option_unitbartitleheightt',
		type = 'number',
		min = 0, max = 7000, step = 50,
		value = 500,
		OnChange = OptionsChanged,
	...
	featureMaxHeight = {
		i18nKey = i18nPrefix .. 'option_wreckagebarfadeheight',
		type = 'number',
		min = 0, max = 7000, step = 50,
		value = 2200,
		OnChange = OptionsChanged,
	...
	featurePercentHeight = {
		i18nKey = i18nPrefix .. 'option_wreckagebarpercentageheight',
		type = 'number',
		min = 0, max = 7000, step = 50,
		value = 500,
		OnChange = OptionsChanged,
	...
	featureTitleHeight = {
		i18nKey = i18nPrefix .. 'option_wreckagebartitleheightt',
		type = 'number',
		min = 0, max = 7000, step = 50,
		value = 500,
		OnChange = OptionsChanged,
