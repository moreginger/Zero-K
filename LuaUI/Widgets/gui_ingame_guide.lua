...
options = {
	ingameguide_concept_wreckage = {
		i18nKey = i18nPrefix .. 'option_wreckage',
	...
	ingameguide_concept_radar = {
		i18nKey = i18nPrefix .. 'option_radar',
	...
	ingameguide_concept_cloak = {
		i18nKey = i18nPrefix .. 'option_cloak',
	...
	ingameguide_damage_slow = {
		i18nKey = i18nPrefix .. 'option_slow',
	...
	ingameguide_damage_disarm = {
		i18nKey = i18nPrefix .. 'option_disarm',
	...
	ingameguide_damage_fire = {
		i18nKey = i18nPrefix .. 'option_fire',
	...
	ingameguide_roles_raider = {
		i18nKey = i18nPrefix .. 'option_raider',
	...
	ingameguide_roles_skirm = {
		i18nKey = i18nPrefix .. 'option_skirmisher',
	...
	ingameguide_roles_riot = {
		i18nKey = i18nPrefix .. 'option_riot',
	...
	ingameguide_ui_priority = {
		i18nKey = i18nPrefix .. 'option_priority',
	...
	ingameguide_ui_repeat = {
		i18nKey = i18nPrefix .. 'option_repeat',
	...
	ingameguide_ui_labels = {
		i18nKey = i18nPrefix .. 'option_labels',
	...
	ingameguide_ui_ferryroutes = {
		i18nKey = i18nPrefix .. 'option_ferryroutes',
	...
	ingameguide_ui_retreat = {
		i18nKey = i18nPrefix .. 'option_retreat',
	...
	ingameguide_ui_firestates = {
		i18nKey = i18nPrefix .. 'option_firestates',
	...
	ingameguide_ui_movestates = {
		i18nKey = i18nPrefix .. 'option_movestates',
