...
options = {
	reload = {
		i18nKey = i18nPrefix .. 'option_reloadcegs',
		type = 'button',
		OnChange = function() Spring.SendCommands('reloadcegs') end,
	},
	
	xdir = {
		i18nKey = i18nPrefix .. 'option_x11',
		type = 'number',
		min = -1, max = 1, step = 0.1,
		value = 0,
	},
	ydir = {
		i18nKey = i18nPrefix .. 'option_y11',
		type = 'number',
		min = -1, max = 1, step = 0.1,
		value = 0,
	},
	zdir = {
		i18nKey = i18nPrefix .. 'option_z11',
		type = 'number',
		min = -1, max = 1, step = 0.1,
		value = 0,
	},
	radius = {
		i18nKey = i18nPrefix .. 'option_radius0100',
		type = 'number',
