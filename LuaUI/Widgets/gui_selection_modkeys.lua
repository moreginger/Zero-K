...
options = {
	leeway_time = {
		i18nKey = i18nPrefix .. 'option_selectionleewaytimeseconds',
		type = 'number',
		value = 0.15,
	...
	leeway_distance = {
		i18nKey = i18nPrefix .. 'option_selectionleewaydistancepixels',
		type = 'number',
		value = 150,
	...
	enable = {
		i18nKey = i18nPrefix .. 'option_newleftclickselectionmodifiers',
		type = "bool",
		value = true,
		noHotkey = true,
		advanced = true,
